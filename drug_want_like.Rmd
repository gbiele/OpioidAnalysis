...
Here we visualize self-reported drug wanting and liking after each drug administrations.

The data for the second drug administration include only participants who wanted a second dosage that was larger than zero.

```{r, fig.cap="Mean and 95% CIs for drug liking, disliking, and wanting after the administration of the first and second dose, stratified by drug and state condition."}
