...
Here we repeat the analysis with sex effects and also adjust for contraceptive use.
...
```{r}
my_caption = "Sensitibity analysis contraception: Effect of stress on effect obtained by sex, over all, and sex difference"
my_footnote = "CI: Upper and lower bound of 95% credible intervals. P > 0: Posterior probability that the parameter or contrast is larger than 0."
plot.stats_table_obtained$stats[,.(Sex, mean, CI, `P > 0`)] %>% 
  .[, Sex := factor(Sex, levels = c("total","women","men","sex diff: m-f"))] %>% 
  setkeyv("Sex") %>% 
...
Here we repeat the analysis with sex effects and also adjust for nicotine use.
...
```{r}
my_caption = "Sensitibity analysis nicotine: Effect of stress on effect obtained by sex, over all, and sex difference"
my_footnote = "CI: Upper and lower bound of 95% credible intervals. P > 0: Posterior probability that the parameter or contrast is larger than 0."
plot.stats_table_obtained$stats[,.(Sex, mean, CI, `P > 0`)] %>% 
  .[, Sex := factor(Sex, levels = c("total","women","men","sex diff: m-f"))] %>% 
  setkeyv("Sex") %>% 
